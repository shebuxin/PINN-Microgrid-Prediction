...
\graphicspath{{/mnt/data/week7_outputs_complete/}}
...
\centering
\includegraphics[width=0.76\textwidth]{week7_precision_recall_curves.png}
\end{frame}

\begin{frame}{Saved PF Calls vs Missed Violations}
\centering
\includegraphics[width=0.76\textwidth]{week7_saved_calls_vs_missed_violations.png}
\end{frame}
...
\centering
\includegraphics[width=0.76\textwidth]{week7_topk_violation_recall.png}
\end{frame}
