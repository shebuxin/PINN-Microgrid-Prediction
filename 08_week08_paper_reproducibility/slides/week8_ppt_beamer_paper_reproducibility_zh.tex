...
\graphicspath{{/mnt/data/week8_outputs_complete/paper/figures/}{/mnt/data/week8_outputs_complete/}}
...
\centering
\includegraphics[width=0.82\textwidth]{fig5_week7_topk_violation_recall.png}
\end{frame}

\begin{frame}{Figure: Group CV Recall}
\centering
\includegraphics[width=0.82\textwidth]{fig6_week7_group_cv_recall.png}
\end{frame}

\begin{frame}{Figure: True vs Predicted Severity}
\centering
\includegraphics[width=0.82\textwidth]{fig7_week6_true_vs_predicted_severity.png}
\end{frame}
