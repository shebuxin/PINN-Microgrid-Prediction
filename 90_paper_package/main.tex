...
The PI-MLP predicts a violation probability, severity score, and component margins. The loss combines classification, severity, component-margin, consistency, and ranking losses.
