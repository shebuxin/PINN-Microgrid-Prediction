...
\begin{itemize}
  ...
  \item $|Z|^2 \cdot |I|^2$ -- the squared-current correction. It is related to branch losses but has units of squared voltage in this equation.
\end{itemize}
\vspace{0.5em}
...
\begin{tabular}{lcc}
\toprule
Bus & $|V|$ from converged BFS & $|V|$ from LinDistFlow \\
\midrule
2 & 0.983 & 0.984 \\
3 & 0.964 & 0.967 \\
4 & 0.951 & 0.954 \\
...
On this feeder, LinDistFlow is close but slightly optimistic: the largest voltage-magnitude difference is about $0.003$ pu. The approximation is useful for planning intuition, not a replacement for the converged nonlinear result near a limit.
\end{block}
\end{frame}
