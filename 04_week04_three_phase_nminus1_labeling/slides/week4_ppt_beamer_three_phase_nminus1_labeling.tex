...
\tikzstyle{box}=[draw, rounded corners, minimum width=2.3cm, minimum height=0.72cm, align=center]
...
\end{block}
\begin{itemize}
  \item Week 4 阈值：$\mathrm{VUF}^{max}=3\%$。
...
\begin{enumerate}
  ...
  \item 把 $VUF^{max}$ 从 3\% 改成 1\%，观察 VUF label 是否出现。
